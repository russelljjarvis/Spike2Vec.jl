...
onset = 500#packet_window_boundaries[1][2][1]
duration = 1580
#@show(onset)
...
display(Plots.scatter(Tx,Nx,legend = false,markersize = 0.8,markerstrokewidth=0,alpha=0.8, bgcolor=:snow2, fontcolor=:blue, xlims=(minimum(Tx), xlimits)))
