...
(_,_,_,_,_,_) = get_divisions(nodes,times,resolution,numb_neurons,maxt,plot=true,metric="autocov")
(_,_,_,_,_,_) = get_divisions(nodes,times,resolution,numb_neurons,maxt,plot=true,metric="LV")
